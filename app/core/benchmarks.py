...
PREBUILT_BENCHMARKS = [
    {
        ...
        "groups": [
            {"id": "g1", "name": "Greetings", "color": "#3b82f6", "texts": ["Hello, how are you today?", "Bonjour, comment ça va aujourd'hui ?", "Hola, ¿cómo estás hoy?"]},
            {"id": "g2", "name": "Food", "color": "#f59e0b", "texts": ["I would like to order a pizza.", "Je voudrais commander une pizza.", "Me gustaría pedir una pizza."]},
            {
                "id": "g3",
                "name": "Technology",
                "color": "#10b981",
    ...
    },
    {
        ...
        "groups": [
            ...
            {"id": "g3", "name": "Walking", "color": "#0ea5e9", "texts": ["He sauntered down the street.", "She strolled through the park.", "They ambled along the beach."]},
        ],
    },
    {
        ...
        "groups": [
            ...
            },
            {
                ...
                "texts": [
                    ...
                    "A river flows from its source to the sea.",
                ],
            },
        ],
    },
