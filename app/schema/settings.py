...
class AppSettingsModel(BaseModel):
    ...
    retry_base_delay_ms: int = Field(default=50, ge=10, le=5000, description="Base delay in milliseconds for exponential backoff between retries")
    ...
    # --- SECURITY ---
    blocked_ollama_endpoints: str = Field(default="pull,delete,create,copy,push", description="Comma-separated list of Ollama API paths to block for API key holders.")
